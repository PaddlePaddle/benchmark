...
function _analysis_log(){
    python scripts/blip2/analysis_log.py ${model_item} ${log_file} ${speed_log_file} ${device_num} ${base_batch_size} ${fp_item} ${run_process_type}
}
...
function _train(){
    ...
    train_cmd="scripts/blip2/train.py \
            --cfg-path \
