...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash -x run_benchmark.sh ${model_item} ${bs_item} ${fp_item} ${run_process_type} ${run_mode} ${device_num} ${max_epochs} ${num_workers} ${node_num} ${node_rank} ${master_addr} ${master_port} 2>&1;