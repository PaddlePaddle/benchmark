...
function _train(){
    ...
    train_options="--batch_size=${base_batch_size} --num_epochs=${max_epochs} --print_iter=1"

    case ${run_process_type} in
    SingleP) train_cmd="python train.py ${train_options} --lr=0.00001 --gpus=0" ;;
    MultiP) train_cmd="python train.py ${train_options} --lr=0.0001 --gpus=0,1,2,3,4,5,6,7" ;;
