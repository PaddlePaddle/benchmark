...
function _train(){
    ...
    train_config="configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/hrnet_w32_coco_256x192.py"
    ...
    SingleP) train_cmd="python tools/train.py ${train_config} ${train_options} optimizer.lr=0.0005 " ;;
    MultiP) train_cmd="bash ./tools/dist_train.sh ${train_config} 8 ${train_options} optimizer.lr=0.0005 " ;;
