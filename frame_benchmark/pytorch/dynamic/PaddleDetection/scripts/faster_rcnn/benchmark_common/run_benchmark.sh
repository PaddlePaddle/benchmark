...
function _train(){
    ...
    train_config="configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py"
    ...
    MultiP) train_cmd="bash ./tools/dist_train.sh ${train_config} 8 ${train_options} optimizer.lr=0.02 " ;;
