...
function _train(){
    ...
    train_config="configs/body/2d_kpt_sview_rgb_img/associative_embedding/coco/higherhrnet_w32_coco_512x512.py"
    ...
    SingleP) train_cmd="python tools/train.py ${train_config} ${train_options} optimizer.lr=0.0015 " ;;
    MultiP) train_cmd="bash ./tools/dist_train.sh ${train_config} 8 ${train_options} optimizer.lr=0.0015 " ;;
