...
function _train(){
    ...
    train_options="ILSVRC2012_w --model resnet50 --lr 0.1 --warmup-epochs 0 --epochs ${max_epochs} --weight-decay 1e-4 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
