...
function _train(){
    ...
    train_options="ILSVRC2012_w --model mobilenetv2_050 --epochs ${max_epochs} --smoothing 0.0 --weight-decay 3e-5 --lr 0.045 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
