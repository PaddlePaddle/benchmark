...
function _train(){
    ...
    train_options="ILSVRC2012_w --model efficientnet_b1 --epochs ${max_epochs} --img-size 240 --opt RMSProp --weight-decay 1e-5 --lr 0.032 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
