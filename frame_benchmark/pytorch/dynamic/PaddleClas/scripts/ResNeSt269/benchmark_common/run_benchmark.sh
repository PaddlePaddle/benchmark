...
function _train(){
    ...
    train_options="ILSVRC2012_w --model ResNeSt269 --epochs ${max_epochs} --img-size 416 --weight-decay 1e-4 --lr 0.1 --sched cosine --mixup 0.2 --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
