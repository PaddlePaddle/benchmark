...
function _train(){
    ...
    train_options="ILSVRC2012_w --model ghostnet_050 --epochs ${max_epochs} --warmup-epochs 5 --weight-decay 4e-5 --lr 0.8 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
