...
function _train(){
    ...
    train_options="ILSVRC2012_w --model vit_base_patch16_clip_224 --epochs ${max_epochs} --opt adamw --weight-decay 0.05 --lr 3e-4 --min-lr 1e-6 --warmup-epochs 10 --warmup-lr 1e-6 --sched cosine --hflip 0.5 --aa rand-m9-mstd0.5-inc1 --reprob 0.25 --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
