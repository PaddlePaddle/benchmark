...
function _train(){
    ...
    train_options="ILSVRC2012_w --model resnet152 --epochs ${max_epochs} --smoothing 0.0 --weight-decay 1e-4 --lr 0.1 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
