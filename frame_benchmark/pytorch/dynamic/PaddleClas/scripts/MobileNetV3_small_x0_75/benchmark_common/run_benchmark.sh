...
function _train(){
    ...
    train_options="ILSVRC2012_w --model mobilenetv3_small_075 --epochs ${max_epochs} --weight-decay 2e-5 --lr 1.3 --warmup-epochs 5 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
