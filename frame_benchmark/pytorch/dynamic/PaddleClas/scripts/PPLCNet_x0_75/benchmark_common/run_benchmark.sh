...
function _train(){
    ...
    train_options="ILSVRC2012_w --model lcnet_075 --epochs ${max_epochs} --weight-decay 3e-5 --lr 0.8 --warmup-epochs 5 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
