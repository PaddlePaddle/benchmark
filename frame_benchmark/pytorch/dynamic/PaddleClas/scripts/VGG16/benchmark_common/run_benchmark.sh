...
function _train(){
    ...
    train_options="ILSVRC2012_w --model vgg16 --epochs ${max_epochs} --smoothing 0.0 --weight-decay 4e-4 --lr 0.01 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
