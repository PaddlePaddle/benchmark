...
function _train(){
    ...
    train_options="ILSVRC2012_w --model mobilenetv3_large_100 --lr 0.65 --warmup-epochs 5 --epochs ${max_epochs} --weight-decay 2e-5 --sched cosine --aa rand-m9-mstd0.5 --batch-size ${batch_size} --workers ${num_workers}"
