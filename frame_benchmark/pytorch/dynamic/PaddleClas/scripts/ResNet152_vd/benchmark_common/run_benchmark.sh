...
function _train(){
    ...
    train_options="ILSVRC2012_w --model resnet152d --epochs ${max_epochs} --weight-decay 1e-4 --lr 0.1 --sched cosine --mixup 0.2 --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
