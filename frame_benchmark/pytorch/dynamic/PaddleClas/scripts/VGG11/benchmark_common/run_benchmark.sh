...
function _train(){
    ...
    train_options="ILSVRC2012_w --model vgg11 --epochs ${max_epochs} --smoothing 0.0 --weight-decay 2e-4 --lr 0.1 --sched cosine --batch-size ${batch_size} --workers ${num_workers} --log-interval 1"
