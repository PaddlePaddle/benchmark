...
train_pipeline = [
    ...
    dict(type='MSResizeCropFlipImage', data_aug_conf = ida_aug_conf, training=True, view_num=12),
...
test_pipeline = [
    ...
    dict(type='MSResizeCropFlipImage', data_aug_conf = ida_aug_conf, training=False, view_num=12),
    dict(type='NormalizeMultiviewImage', **img_norm_cfg),
    dict(type='PadMultiViewImage', size_divisor=32),
    dict(
