...
export model_item=PP-LiteSeg-T
export model_type=dynamicTostatic
export batch_size=4
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=PP-LiteSeg-T_bs4_fp16_DP
export job_name=PaddleX_semantic_segmentation_PP-LiteSeg-T_bs4_fp16_DP_N1C8_d2sT
...
export FLAGS_force_stride_compute_contig_out=1 #stride机制导致性能下降，需要开始这个flag后性能恢复

train_cmd="python main.py -c paddlex/configs/modules/semantic_segmentation/PP-LiteSeg-T.yaml -o Global.mode=train -o Global.dataset_dir=dataset/cityscapes_train_benchmark -o Train.log_interval=15 -o Train.num_classes=19 -o Benchmark.shuffle=False -o Benchmark.print_mem_info=True -o Benchmark.seed=100 -o Benchmark.repeats=500 -o Benchmark.num_workers=8 -o Benchmark.do_eval=False -o Benchmark.disable_deamon=True -o Benchmark.env.FLAGS_eager_delete_tensor_gb=0.0 -o Benchmark.env.FLAGS_fraction_of_gpu_memory_to_use=0.98 -o Benchmark.env.FLAGS_conv_workspace_size_limit=4096 -o Global.model=PP-LiteSeg-T -o Train.epochs_iters=400 -o Train.batch_size=4 -o Benchmark.amp=O2 -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.output=output/${job_name} -o Train.dy2st=True -o Train.uniform_output_enabled=False"
