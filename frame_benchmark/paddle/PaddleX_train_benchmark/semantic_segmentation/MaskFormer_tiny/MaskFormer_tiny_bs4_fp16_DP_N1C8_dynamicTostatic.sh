...
export model_item=MaskFormer_tiny
export model_type=dynamicTostatic
export batch_size=4
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=MaskFormer_tiny_bs4_fp16_DP
export job_name=PaddleX_semantic_segmentation_MaskFormer_tiny_bs4_fp16_DP_N1C8_d2sT
