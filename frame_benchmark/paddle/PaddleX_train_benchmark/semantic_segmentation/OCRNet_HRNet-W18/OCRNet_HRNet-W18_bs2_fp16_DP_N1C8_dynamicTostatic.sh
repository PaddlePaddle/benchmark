...
export model_item=OCRNet_HRNet-W18
export model_type=dynamicTostatic
export batch_size=2
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=OCRNet_HRNet-W18_bs2_fp16_DP
export job_name=PaddleX_semantic_segmentation_OCRNet_HRNet-W18_bs2_fp16_DP_N1C8_d2sT
