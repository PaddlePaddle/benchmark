...
export model_item=Deeplabv3-R50
export model_type=dynamic
export batch_size=4
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=Deeplabv3-R50_bs4_fp16_DP
export job_name=PaddleX_semantic_segmentation_Deeplabv3-R50_bs4_fp16_DP_N1C8
