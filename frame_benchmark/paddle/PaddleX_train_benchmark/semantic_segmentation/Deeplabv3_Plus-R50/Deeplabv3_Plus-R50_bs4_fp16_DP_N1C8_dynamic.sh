...
export model_item=Deeplabv3_Plus-R50
export model_type=dynamic
export batch_size=4
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=Deeplabv3_Plus-R50_bs4_fp16_DP
export job_name=PaddleX_semantic_segmentation_Deeplabv3_Plus-R50_bs4_fp16_DP_N1C8
...
train_cmd="python main.py -c paddlex/configs/semantic_segmentation/Deeplabv3_Plus-R50.yaml -o Global.mode=train -o Global.dataset_dir=dataset/cityscapes_train_benchmark -o Train.epochs_iters=10000 -o Train.log_interval=15 -o Train.num_classes=19 -o Benchmark.print_mem_info=True -o Benchmark.seed=100 -o Benchmark.repeats=500 -o Benchmark.num_workers=8 -o Benchmark.do_eval=False -o Benchmark.disable_deamon=True -o Benchmark.env.FLAGS_eager_delete_tensor_gb=0.0 -o Benchmark.env.FLAGS_fraction_of_gpu_memory_to_use=0.98 -o Benchmark.env.FLAGS_conv_workspace_size_limit=4096 -o Global.model=Deeplabv3_Plus-R50 -o Train.batch_size=4 -o Benchmark.amp=O2 -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.output=output/${job_name}"
