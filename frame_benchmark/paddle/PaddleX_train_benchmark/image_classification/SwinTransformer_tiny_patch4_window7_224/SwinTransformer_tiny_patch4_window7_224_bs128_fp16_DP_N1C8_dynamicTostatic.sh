...
export model_item=SwinTransformer_tiny_patch4_window7_224
export model_type=dynamicTostatic
export batch_size=128
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=SwinTransformer_tiny_patch4_window7_224_bs128_fp16_DP
export job_name=PaddleX_image_classification_SwinTransformer_tiny_patch4_window7_224_bs128_fp16_DP_N1C8_d2sT
...
train_cmd="python main.py -c paddlex/configs/modules/image_classification/SwinTransformer_tiny_patch4_window7_224.yaml -o Global.mode=train -o Global.dataset_dir=dataset/ILSVRC2012_train_benchmark -o Train.epochs_iters=1 -o Train.log_interval=1 -o Train.num_classes=1000 -o Benchmark.shuffle=False -o Benchmark.shared_memory=True -o Benchmark.print_mem_info=True -o Benchmark.seed=1234 -o Benchmark.do_eval=False -o Benchmark.disable_deamon=True -o Benchmark.env.FLAGS_eager_delete_tensor_gb=0.0 -o Benchmark.env.FLAGS_fraction_of_gpu_memory_to_use=0.98 -o Benchmark.env.FLAGS_conv_workspace_size_limit=4096 -o Global.model=SwinTransformer_tiny_patch4_window7_224 -o Train.batch_size=128 -o Benchmark.dali=False -o Benchmark.num_workers=12 -o Benchmark.amp=O2 -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.output=output/${job_name} -o Train.uniform_output_enabled=False -o Train.dy2st=True"
