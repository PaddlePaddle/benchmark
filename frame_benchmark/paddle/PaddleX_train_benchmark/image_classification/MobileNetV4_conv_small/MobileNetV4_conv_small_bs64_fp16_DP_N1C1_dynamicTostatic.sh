...
export model_item=MobileNetV4_conv_small
export model_type=dynamicTostatic
export batch_size=64
export fp_item=fp16
export run_mode=DP
export device_num=N1C1
export model_name=MobileNetV4_conv_small_bs64_fp16_DP
export job_name=PaddleX_image_classification_MobileNetV4_conv_small_bs64_fp16_DP_N1C1_d2sT
