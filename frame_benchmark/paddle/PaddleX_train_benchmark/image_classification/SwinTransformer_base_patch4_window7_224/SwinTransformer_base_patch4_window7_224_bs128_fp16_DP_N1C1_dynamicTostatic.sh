...
export model_item=SwinTransformer_base_patch4_window7_224
export model_type=dynamicTostatic
export batch_size=128
export fp_item=fp16
export run_mode=DP
export device_num=N1C1
export model_name=SwinTransformer_base_patch4_window7_224_bs128_fp16_DP
export job_name=PaddleX_image_classification_SwinTransformer_base_patch4_window7_224_bs128_fp16_DP_N1C1_d2sT
