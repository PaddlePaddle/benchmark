...
export model_item=PP-HGNet_small
export model_type=dynamicTostatic
export batch_size=128
export fp_item=fp16
export run_mode=DP
export device_num=N1C1
export model_name=PP-HGNet_small_bs128_fp16_DP
export job_name=PaddleX_image_classification_PP-HGNet_small_bs128_fp16_DP_N1C1_d2sT
