...
export model_item=ResNet50
export model_type=dynamicTostatic
export batch_size=256
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=ResNet50_bs256_fp16_DP
export job_name=PaddleX_image_classification_ResNet50_bs256_fp16_DP_N1C8_d2sT
