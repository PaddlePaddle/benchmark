...
export model_item=PP-LCNetV2_base
export model_type=dynamicTostatic
export batch_size=500
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=PP-LCNetV2_base_bs500_fp16_DP
export job_name=PaddleX_image_classification_PP-LCNetV2_base_bs500_fp16_DP_N1C8_d2sT
