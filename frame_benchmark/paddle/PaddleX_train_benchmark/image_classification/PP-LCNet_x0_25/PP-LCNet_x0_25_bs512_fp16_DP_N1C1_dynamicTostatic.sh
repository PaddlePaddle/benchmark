...
export model_item=PP-LCNet_x0_25
export model_type=dynamicTostatic
export batch_size=512
export fp_item=fp16
export run_mode=DP
export device_num=N1C1
export model_name=PP-LCNet_x0_25_bs512_fp16_DP
export job_name=PaddleX_image_classification_PP-LCNet_x0_25_bs512_fp16_DP_N1C1_d2sT
