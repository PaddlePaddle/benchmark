...
export model_item=MobileNetV3_large_x1_0
export model_type=dynamicTostatic
export batch_size=640
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=MobileNetV3_large_x1_0_bs640_fp16_DP
export job_name=PaddleX_image_classification_MobileNetV3_large_x1_0_bs640_fp16_DP_N1C8_d2sT
