...
export model_item=PP-HGNet_tiny
export model_type=dynamicTostatic
export batch_size=128
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=PP-HGNet_tiny_bs128_fp16_DP
export job_name=PaddleX_image_classification_PP-HGNet_tiny_bs128_fp16_DP_N1C8_d2sT
