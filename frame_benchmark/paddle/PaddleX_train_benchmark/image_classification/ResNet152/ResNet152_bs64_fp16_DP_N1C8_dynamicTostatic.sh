...
export model_item=ResNet152
export model_type=dynamicTostatic
export batch_size=64
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=ResNet152_bs64_fp16_DP
export job_name=PaddleX_image_classification_ResNet152_bs64_fp16_DP_N1C8_d2sT
