...
export model_item=Nonstationary
export model_type=dynamic
export batch_size=16
export fp_item=fp32
export run_mode=DP
export device_num=N1C1
export model_name=Nonstationary_bs16_fp32_DP
export job_name=PaddleX_ts_forecast_Nonstationary_bs16_fp32_DP_N1C1
export skip_steps=5
export keyword="ips: "
...
train_cmd="python main.py -c paddlex/configs/ts_forecast/Nonstationary.yaml -o Global.mode=train -o Global.dataset_dir=dataset/ts_dataset_examples -o Train.epochs_iters=5 -o Train.patience=40 -o Benchmark.print_mem_info=True -o Benchmark.disable_deamon=True -o Benchmark.env.FLAGS_eager_delete_tensor_gb=0.0 -o Benchmark.env.FLAGS_fraction_of_gpu_memory_to_use=0.98 -o Benchmark.env.FLAGS_conv_workspace_size_limit=4096 -o Global.model=Nonstationary -o Train.batch_size=16 -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.output=output/${job_name}"
