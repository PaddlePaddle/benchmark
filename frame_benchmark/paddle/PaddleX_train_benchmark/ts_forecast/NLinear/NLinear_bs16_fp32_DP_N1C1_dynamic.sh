...
export model_item=NLinear
export model_type=dynamic
export batch_size=16
export fp_item=fp32
export run_mode=DP
export device_num=N1C1
export model_name=NLinear_bs16_fp32_DP
export job_name=PaddleX_ts_forecast_NLinear_bs16_fp32_DP_N1C1
export skip_steps=5
export keyword="ips: "
