...
export model_item=PP-OCRv4_server_rec
export model_type=dynamicTostatic
export batch_size=256
export fp_item=fp16
export run_mode=DP
export device_num=N1C8
export model_name=PP-OCRv4_server_rec_bs256_fp16_DP
export job_name=PaddleX_text_recognition_PP-OCRv4_server_rec_bs256_fp16_DP_N1C8_d2sT
