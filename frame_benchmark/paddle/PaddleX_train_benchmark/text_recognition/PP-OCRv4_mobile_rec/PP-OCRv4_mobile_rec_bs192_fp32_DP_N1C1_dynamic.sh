...
export job_name=PaddleX_text_recognition_PP-OCRv4_mobile_rec_bs192_fp32_DP_N1C1
...
train_cmd="python main.py -c paddlex/configs/text_recognition/PP-OCRv4_mobile_rec.yaml -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.mode=train -o Global.dataset_dir=dataset/ocr_rec_dataset_train_benchmark -o Global.output=output/${job_name} -o Train.batch_size=192 -o Train.log_interval=1 -o Train.epochs_iters=1"
