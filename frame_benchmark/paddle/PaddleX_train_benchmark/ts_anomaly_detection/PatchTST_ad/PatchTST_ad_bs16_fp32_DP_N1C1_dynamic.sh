...
export job_name=PaddleX_ts_anomaly_detection_PatchTST_ad_bs16_fp32_DP_N1C1
export skip_steps=2
export keyword="ips: "
...
train_cmd="python main.py -c paddlex/configs/ts_anomaly_detection/PatchTST_ad.yaml -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.mode=train -o Global.dataset_dir=dataset/ts_anomaly_detection_train_benchmark -o Global.output=output/${job_name} -o Train.batch_size=16 -o Train.epochs_iters=20"
