...
export model_item=Mask-RT-DETR-L
export model_type=dynamicTostatic
export batch_size=2
export fp_item=fp32
export run_mode=DP
export device_num=N1C8
export model_name=Mask-RT-DETR-L_bs2_fp32_DP
export job_name=PaddleX_instance_segmentation_Mask-RT-DETR-L_bs2_fp32_DP_N1C8_d2sT
