...
#bash PaddleX/train_benchmark/instance_segmentation/prepare.sh

export model_item=MaskRCNN-ResNet50-FPN
export model_type=dynamicTostatic
export batch_size=4
export fp_item=amp
export run_mode=DP
export device_num=N1C8
export model_name=MaskRCNN-ResNet50-FPN_bs4_amp_DP
export job_name=PaddleX_instance_segmentation_MaskRCNN-ResNet50-FPN_bs4_amp_DP_N1C8_d2sT
...
train_cmd="python main.py -c paddlex/configs/modules/instance_segmentation/MaskRCNN-ResNet50-FPN.yaml -o Global.mode=train -o Global.dataset_dir=dataset/coco_train_benchmark -o Train.epochs_iters=1 -o Train.log_interval=1 -o Train.num_classes=80 -o Benchmark.shuffle=False -o Benchmark.shared_memory=True -o Benchmark.print_mem_info=True -o Benchmark.do_eval=False -o Benchmark.disable_deamon=True -o Benchmark.env.FLAGS_eager_delete_tensor_gb=0.0 -o Benchmark.env.FLAGS_fraction_of_gpu_memory_to_use=0.98 -o Benchmark.env.FLAGS_conv_workspace_size_limit=4096 -o Global.model=MaskRCNN-ResNet50-FPN -o Train.batch_size=4 -o Benchmark.num_workers=16 -o Benchmark.amp=O1 -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.output=output/${job_name} -o Train.uniform_output_enabled=False -o Train.dy2st=True"
