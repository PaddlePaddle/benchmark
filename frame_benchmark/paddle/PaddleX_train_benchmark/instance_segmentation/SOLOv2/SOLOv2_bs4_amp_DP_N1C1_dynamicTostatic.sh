...
export model_item=SOLOv2
export model_type=dynamicTostatic
export batch_size=4
export fp_item=amp
export run_mode=DP
export device_num=N1C1
export model_name=SOLOv2_bs4_amp_DP
export job_name=PaddleX_instance_segmentation_SOLOv2_bs4_amp_DP_N1C1_d2sT
