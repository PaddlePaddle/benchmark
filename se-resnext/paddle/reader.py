...
def train(batch_size, data_dir=DATA_DIR, shuffle_seed=None):
...
def val(batch_size, data_dir=DATA_DIR):
    ...
    return _reader_creator(file_list, batch_size, 'val', shuffle=False,
            data_dir=data_dir)


def test(batch_size, data_dir=DATA_DIR):
    file_list = os.path.join(data_dir, 'val_list.txt')
    return _reader_creator(file_list, batch_size, 'test', shuffle=False,
            data_dir=data_dir)
