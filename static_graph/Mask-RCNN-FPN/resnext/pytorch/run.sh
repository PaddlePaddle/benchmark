...
run_mode="$3"
run_log_path=${4:-$(pwd)}
model_name="mask_rcnn_fpn_resnext"
...
train(){
  ...
  train_cmd="python -u tools/train_net.py --cfg configs/12_2017_baselines/e2e_mask_rcnn_X-101-64x4d-FPN_1x.yaml  \
       	  OUTPUT_DIR ./output"
