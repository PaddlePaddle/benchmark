...
sed -i '81 s/^/  config.gpu_options.allow_growth = False\n/' /usr/local/lib/python2.7/dist-packages/tensor2tensor/utils/trainer_lib.py   # add this command for mem, it will be updated in run_transformer.sh according to the run_type
