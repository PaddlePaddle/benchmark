...
def parse_args():
    ...
    parser.add_argument('--MAX_GPU_TEMPERATURE_USE', type=str, default='0', help='C')
...
if __name__ == "__main__":
    ...
    with open(args.speed_log_file, "r") as read_file:
        ...
        data["MAX_GPU_MEMORY_USE"] = args.MAX_GPU_MEMORY_USE
        data["AVG_GPU_USE"] = round(float(args.AVG_GPU_USE), 3)
        data["MAX_GPU_TEMPERATURE_USE"] = args.MAX_GPU_TEMPERATURE_USE
