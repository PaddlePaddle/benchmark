...
function construnct_version2(){
    if [[ ${cuda_version} == '11.2' ]];then
        ...
        wget -q https://paddle-qa.bj.bcebos.com/WheelBenchmark/linux-gpu-cuda11.2-cudnn8-mkl-gcc8.2-avx/${image_commit_id}/${IMAGE_NAME} -P ${all_path}/images/${PADDLE_VERSION}/
        ...
        mkdir ${all_path}/images/${PADDLE_VERSION}
        wget -q https://paddle-qa.bj.bcebos.com/WheelBenchmark/linux-gpu-cuda10.1-cudnn7-mkl-gcc5.4-avx/${image_commit_id}/${IMAGE_NAME} -P ${all_path}/images/${PADDLE_VERSION}/
