...
cur_model_list=(dy_lac dy_transformer dy_wavenet dy_senta dy_mask_rcnn dy_mask_rcnn dy_slowfast dy_tsn dy_tsm dy_gan dy_seg dy_seq2seq dy_resnet dy_ptb_lm dy_mobilenet)
