...
cur_model_list=(dy_bmn dy_tsn dy_tsm dy_video_TimeSformer dy_bert dy_lac dy_transformer dy_yolov3 dy_slowfast dy_gan dy_seg dy_seq2seq dy_resnet dy_ptb_medium dy_mobilenet dy_ppocr_mobile_2 dy_faster_rcnn_fpn \
