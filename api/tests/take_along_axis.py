...
@benchmark_registry.register("take_along_axis")
...
@benchmark_registry.register("take_along_axis")
class PaddleTakeAlongAxis(PaddleOpBenchmarkBase):
    def build_graph(self, config):
        ...
        result = paddle.take_along_axis(
            arr=arr, indices=indices, axis=config.axis)
