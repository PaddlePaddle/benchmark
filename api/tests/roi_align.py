...
@benchmark_registry.register("roi_align")
class ROIAlignConfig(APIConfig):
    def __init__(self):
        super(ROIAlignConfig, self).__init__("roi_align")
        self.run_torch = False

    def init_from_json(self, filename, config_id=0, unknown_dim=16):
        super(ROIAlignConfig, self).init_from_json(filename, config_id,
                                                   unknown_dim)
...
@benchmark_registry.register("roi_align")
class PaddleROIAlign(PaddleOpBenchmarkBase):
