...
class ElementwiseTwoConfig(APIConfig):
    def __init__(self):
        super(ElementwiseTwoConfig, self).__init__('elementwise_two')
        self.api_name = 'add'
    ...
    def to_tensorflow(self):
        tf_config = super(ElementwiseTwoConfig, self).to_tensorflow()
...
class PDElementwiseTwo(PaddleAPIBenchmarkBase):
...
class TFElementwiseTwo(TensorflowAPIBenchmarkBase):
...
if __name__ == '__main__':
    test_main(
        PDElementwiseTwo(), TFElementwiseTwo(), config=ElementwiseTwoConfig())
