...
run_cmd="cd ${BENCHMARK_ROOT}
        ...
        pip install -v -e .
        CUDA_VISIBLE_DEVICES=0 bash run_benchmark.sh sp 64 fp32 10 hrnet;
        sleep 60;
        CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash run_benchmark.sh mp 64 fp32 1 hrnet;
        sleep 60;
        CUDA_VISIBLE_DEVICES=0 bash run_benchmark.sh sp 160 fp32 1 hrnet;
        sleep 60;
        CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash run_benchmark.sh mp 160 fp32 1 hrnet;
        sleep 60;
