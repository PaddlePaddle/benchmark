...
run_cmd="cp /workspace/scripts/PrepareEnv.sh ./;
         ...
         CUDA_VISIBLE_DEVICES=0 bash run_benchmark.sh styleganv2 sp fp32 16 300 4;
         CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash run_benchmark.sh styleganv2 mp fp32 8 300 4;
         CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash run_benchmark.sh styleganv2 mp fp32 16 300 4;
         "
